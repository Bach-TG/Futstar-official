...
from .data_provider_config import DataProviderConfig
...
redis_config = _config.redis if _config else None
data_provider_config = _config.data_provider if _config else None