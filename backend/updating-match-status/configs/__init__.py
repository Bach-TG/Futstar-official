...
from .futstar_backend_config import FutstarBackendConfig
...
class AppConfig(BaseModel):
    futstar_backend: FutstarBackendConfig
...
futstar_backend_config = _config.futstar_backend if _config else None
