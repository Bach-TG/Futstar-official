...
async def get_stats_data(driver: webdriver.Chrome, wait: WebDriverWait[webdriver.Chrome], title: str, time: str):
    ...
    try:
        attack_stats_record = MatchAttackStats(
            ...
            shots_on_target=(stats_data_dict["shots_on_target"][0], stats_data_dict["shots_on_target"][1]),
            shots_blocked=(stats_data_dict["shots_blocked"][0], stats_data_dict["shots_blocked"][1]),
            shots_headed=(stats_data_dict["shots_headed"][0], stats_data_dict["shots_headed"][1]),
            shots_outside_box=(stats_data_dict["shots_outside_box"][0], stats_data_dict["shots_outside_box"][1]),
            shots_inside_box=(stats_data_dict["shots_inside_box"][0], stats_data_dict["shots_inside_box"][1]),
            shots_accuracy=(stats_data_dict["shots_accuracy"][0], stats_data_dict["shots_accuracy"][1]),
            key_passes=(stats_data_dict["key_passes"][0], stats_data_dict["key_passes"][1]),
            shots_accuracy_excluding_blocked_shots=(stats_data_dict["shots_accuracy_excluding_blocked_shots"][0], stats_data_dict["shots_accuracy_excluding_blocked_shots"][1]),
        )
...
async def main():
    ...
    try:
        ...
        try:
            ...
            tab = wait.until(
                EC.element_to_be_clickable((By.LINK_TEXT, "Attack"))
            )
